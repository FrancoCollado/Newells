...
export default function PlayerReportsPage() {
  ...
  const loadReports = async (currentUser: User, playerId: string, tab: string, pageToLoad: number, reset: boolean) => {
    ...
    if (tab === "todos") {
      // Tanto dirigentes como profesionales pueden ver todos los informes
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {canViewAllReportsTabs ? "Ver todos los informes de los profesionales" : "Ver y gestionar sus informes"}
              </CardDescription>
            </CardHeader>
            <CardContent>
              {canViewAllReportsTabs ? (
                ...
                // Vista de otros roles sin acceso a pestañas
